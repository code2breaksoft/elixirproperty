    ...
    return ( 
        ...
        <section className="snag-props-wrapper">
            ...
            <Row className="snag-props-list box-content">
                <h6>Why property snagging and handover inspection?
</h6>
                
                <p>

                Many experts will say that snagging is more important now than ever before. New house building is at record levels - and developers are under pressure to complete every house quickly - but there's a shortage of many skilled trades. So there's more potential for things to go wrong. Snagging is the process of comprehensive i; Qspection before purchasing a New Property from the Developer.
                </p>
                <p>Following are the important reasons why Property snagging is essential-
                </p>
                <ul className="box-ul">
                <li>Snagging Inspection grants Investor/Home (owner an opportunity to make sure the Unit is in the same condition as agreed in SPA.</li>
